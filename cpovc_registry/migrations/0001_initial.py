...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('beneficiary_id', models.CharField(default=None, max_length=10, null=True, blank=True)),
                ('workforce_id', models.CharField(default=None, max_length=8, null=True, blank=True)),
                ('birth_reg_id', models.CharField(default=None, max_length=15, null=True, blank=True)),
                ('national_id', models.CharField(default=None, max_length=15, null=True, blank=True)),
                ('first_name', models.CharField(max_length=255)),
                ('other_names', models.CharField(default=None, max_length=255, null=True, blank=True)),
