...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='beneficiary_person',
            field=models.ForeignKey(related_name='encouner_n_beneficiary', to='cpovc_registry.RegPerson'),
        ),
        migrations.AddField(
            model_name='coreencountersnotes',
            name='encounter',
        ...
        migrations.AddField(
            ...
            name='beneficiary_person',
            field=models.ForeignKey(related_name='encouner_beneficiary', to='cpovc_registry.RegPerson'),
        ),
        migrations.AddField(
            model_name='coreencounters',
            name='workforce_person',
