...
def reports_ovc_rawdata(request):
    ...
    try:
        ...
        if report_ovc_id == 6 and report_id == 1:
            titles = ['OVCID', 'FIRST_NAME', 'SURNAME', 'OTHER_NAMES',
                      ...
                      'SCHOOLLEVEL', 'IMMUNIZATION', 'CPIMS_ID']
        if report_ovc_id == 6 and report_id == 5:
            titles = ['CHW', 'OVCID', 'FIRST_NAME', 'SURNAME', 'OTHER_NAMES',
                      'DATE_OF_BIRTH', 'AGE', 'AGE_AT_REG', 'GENDER',
                      'REGISTRATION_DATE', 'EXIT_STATUS', 'EXIT_DATE',
                      'OVCHIVSTATUS', 'ARTSTATUS', 'BIRTHCERT', 'BCERTNUMBER',
        ...
        if report_ovc_id == 6 and report_id == 12:
            titles = ['FIRST_NAME', 'SURNAME', 'OTHER_NAMES',
                      'GENDER', 'AGE', 'AGERANGE', 'REGISTRATION_DATE',
                      ...
                      'WARD', 'CHW', 'CAREGIVER', 'CAREGIVERHIVSTATUS']
        data = [titles]
        print 'res', results
        for res in results:
            vals = []
        ...
        if len(results) > 0:
            ...
            if len(results) > 100000 or report_id == 12:
