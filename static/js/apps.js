...
var handleDatepicker = function() {
    $('#date_of_csi, #date_of_hhva, #date_of_certificate_expiry, #disbursement_date, #date_of_adoption, #summon_date, #summon_date_next, #date_of_summon, #honoured_date, #next_hearing_date, #next_mention_date, #adverse_event_date, #admmission_to_school_date, #discharge_date, #expected_return_date, #actual_return_date, #placementfollowup_date, #court_order_issue_date,#child_dob, #date_of_referral_event, #date_of_case_closure, #date_case_opened, #departure_date, #admission_date,#date_of_court_event, #date_of_encounter_event, #date_of_placement_event,#date_of_birth, #date_of_death, #datepicker, #editdate, #date_of_event, #sibling_dob, #audit_date, #caregiver_dob, #reported_date, #olmis_service_date').datepicker({
